 --Problema 1 Del tema Crear una tabla (create table - sp_tables - sp_columns - drop table)
...
drop table agenda;
 ...
 --Problema 2 del tema Crear una tabla (create table - sp_tables - sp_columns - drop table)
...
------------------------------------------------------------------------------------------------------------------------------------------------
--Problema 1 del tema Insertar y recuperar registros de una tabla (insert into - select) 
if object_id('agenda') is not null
	drop table agenda;
...
--Problema 2 del tema Insertar y recuperar registros de una tabla (insert into - select) 
if object_id('libros') is not null
	drop table libros;
...
------------------------------------------------------------------------------------------------------------------------------------------------
--Problema 1 del tema Tipos de datos básicos
...
--Problema 2 del tema Tipos de datos básicos
...
------------------------------------------------------------------------------------------------------------------------------------------------
--Problema 1 del tema Recuperar algunos campos (select)
if object_id('peliculas') is not null
	drop table peliculas;
...
--Problema 2 del tema Recuperar algunos campos (select)
if object_id('empleados') is not null
	drop table empleados;
...
------------------------------------------------------------------------------------------------------------------------------------------------
--Problema 1 del tema Recuperar algunos registros (where)
if object_id('agenda') is not null
	drop table agenda;
...
--Problema 2 del tema Recuperar algunos registros (where)
if object_id('libros') is not null
	drop table libros;
...
------------------------------------------------------------------------------------------------------------------------------------------------
--Problema 1 del tema Operadores relacionales
...
--Problema 2 del tema Operadores relacionales
 if object_id('peliculas') is not null
  drop table peliculas;
...
------------------------------------------------------------------------------------------------------------------------------------------------
--Problema 1 del tema Borrar registros (delete)
 if object_id('agenda') is not null
  drop table agenda;
 ...
 --Problema 2 del tema Borrar registros (delete)
 if object_id('articulos') is not null
  drop table articulos;
 ...
 ------------------------------------------------------------------------------------------------------------------------------------------------
 --problema 1 del tema Actualizar registros (update)
 ...
 select * from agenda;
  ...
  --problema 2 del tema Actualizar registros (update)
   if object_id('libros') is not null
  drop table libros;
 ...
 ------------------------------------------------------------------------------------------------------------------------------------------------
 --Problema 1  del tema Valores null (is null)
...
--Problema 2  del tema Valores null (is null)
if object_id('peliculas') is not null
  drop table peliculas;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Clave primaria
 if object_id('libros') is not null
  drop table libros;
 ...
 --Problema 2 del tema Clave primaria
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Campo con atributo Identity
  if object_id('medicamentos') is not null
  drop table medicamentos;
 ...
 --Problema 2 del tema Campo con atributo Identity
  if object_id('peliculas') is not null
  drop table peliculas;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Otras características del atributo Identity
  if object_id('medicamentos') is not null
  drop table medicamentos;
 ...
 --Problema 2 del tema Otras características del atributo Identity
  if object_id('peliculas') is not null
  drop table peliculas;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema OTruncate table
  if object_id('alumnos') is not null
  drop table alumnos;
 ...
 --Problema 2 del tema OTruncate table
  if object_id('articulos') is not null
  drop table articulos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Tipo de dato (texto)
 ...
 --Problema 2 del tema Tipo de dato (texto)
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Tipo de dato (numerico)
 ...
 --Problema 2 del tema Tipo de dato (numerico)
  if object_id('empleados') is not null
  drop table empleados;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Tipo de dato (fecha y hora)
 if object_id('alumnos') is not null
  drop table alumnos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Ingresar algunos campos (insert into)
 if object_id('cuentas') is not null
  drop table cuentas;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Valores por defecto (default)
 ...
 --Problema 2 del tema Valores por defecto (default)
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Columnas calculadas (operadores aritméticos y de concatenación)
 if object_id ('articulos') is not null
  drop table articulos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Funciones para el uso de fechas y horas
 if object_id ('empleados') is not null
  drop table empleados;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Ordenar registros (order by)
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Operadores lógicos ( and - or - not)
 if object_id('medicamentos') is not null
  drop table medicamentos;
 ...
 --Problema 2 del tema Operadores lógicos ( and - or - not)
 if object_id('peliculas') is not null
  drop table peliculas;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Otros operadores relacionales (is null)
 if object_id('peliculas') is not null
  drop table peliculas;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Otros operadores relacionales (between)
 if object_id('visitas') is not null
  drop table visitas;
 ...
 --Problema 2 del tema Otros operadores relacionales (between)
if object_id('autos') is not null
  drop table autos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Otros operadores relacionales (in)
  if object_id('medicamentos') is not null
  drop table medicamentos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Búsqueda de patrones (like - not like)
 if object_id('empleados') is not null
  drop table empleados;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Contar registros (count)
 if object_id('medicamentos') is not null
  drop table medicamentos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Contar registros (count_big)
 if object_id('medicamentos') is not null
  drop table medicamentos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Funciones de agrupamiento (count - sum - min - max - avg)
 if object_id('empleados') is not null
  drop table empleados;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Agrupar registros (group by)
 if object_id('visitantes') is not null
  drop table visitantes;
 ...
 --Problema 2 del tema Agrupar registros (group by)
 if object_id('empleados') is not null
  drop table empleados;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Seleccionar grupos (having)
 if object_id('clientes') is not null
  drop table clientes;
...
--Problema 1 del tema Seleccionar grupos (having)
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Modificador del group by (with rollup)
 if object_id('clientes') is not null
  drop table clientes;
 ...
 --Problema 2 del tema Modificador del group by (with rollup)
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Modificador del group by (with cube)
if object_id('ventas') is not null
 ...
 --Problema 2 del tema Modificador del group by (with cube)
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Función grouping
 if object_id('empleados') is not null
  drop table empleados;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Cláusulas compute y compute by
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Registros duplicados (distinct)
 if object_id('clientes') is not null
  drop table clientes;
 ...
 --Problema 2 del tema Registros duplicados (distinct)
 if object_id('inmuebles') is not null
  drop table inmuebles;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Cláusula top
 if object_id('empleados') is not null
  drop table empleados;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Clave primaria compuesta
 ...
 insert into consultas
  ...
  --Problema 2 del tema Clave primaria compuesta
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Restricción default
 if object_id('visitantes') is not null
  drop table visitantes;
 ...
 --Problema 2 del tema Restricción default
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Restricción check
 if object_id('empleados') is not null
  drop table empleados;
 ...
 --Problema 2 del tema Restricción check
 if object_id('vehiculos') is not null
  drop table vehiculos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Deshabilitar restricciones (with check - nocheck)
 if object_id('empleados') is not null
  drop table empleados;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Restricción primary key
 if object_id('empleados') is not null
  drop table empleados;
...
--Problema 2 del tema Restricción primary key
if object_id('remis') is not null
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Restricción unique
 if object_id('remis') is not null
  drop table remis;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Eliminar restricciones (alter table - drop)
 if object_id('vehiculos') is not null
  drop table vehiculos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Crear y asociar reglas (create rule - sp_bindrule)
 if object_id('vehiculos') is not null
  drop table vehiculos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Eliminar y dasasociar reglas (sp_unbindrule - drop rule)
 if object_id('vehiculos') is not null
  drop table vehiculos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Valores predeterminados (create default)
 if object_id ('clientes') is not null
  drop table clientes;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Desasociar y eliminar valores predeterminados
  if object_id ('libros') is not null
  drop table libros;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Creación de índices
 if object_id('alumnos') is not null
  drop table alumnos;
 create table alumnos(
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Regenerar índices
 if object_id('alumnos') is not null
  drop table alumnos;
 create table alumnos(
  legajo char(5) not null,
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Eliminar índices
 if object_id('alumnos') is not null
  drop table alumnos;
 create table alumnos(
  legajo char(5) not null,
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Combinación interna (inner join)
  if (object_id('clientes')) is not null
   drop table clientes;
 ...
 --Problema 2 del tema Combinación interna (inner join)
 if (object_id('inscriptos')) is not null
  drop table inscriptos;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Combinación externa izquierda (left join)
 if (object_id('clientes')) is not null
   drop table clientes;
 if (object_id('provincias')) is not null
   drop table provincias;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Combinación externa derecha (right join)
 if (object_id('clientes')) is not null
   drop table clientes;
 if (object_id('provincias')) is not null
   drop table provincias;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema 	Combinación externa completa (full join)
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Combinaciones cruzadas (cross join)
 ...
 --Problema 2 del tema Combinaciones cruzadas (cross join)
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Autocombinación
 if object_id('clientes') is not null
  drop table clientes;
 ...
 --Problema 2 del tema Autocombinación
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Combinaciones y funciones de agrupamiento
 if object_id('visitantes') is not null
  drop table visitantes;
 ...
 -----------------------------------------------------------------------------------------------------------------------------
 --Problema 1 del tema Combinación de más de dos tablas
